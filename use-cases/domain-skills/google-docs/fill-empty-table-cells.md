...
- [interaction-skills/canvas-rendered-editor-input.md](../../interaction-skills/canvas-rendered-editor-input.md) — the underlying mechanic, applies to Slides/Sheets/Canva equivalently.
