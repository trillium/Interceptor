...
- [interaction-skills/canvas-rendered-editor-input.md](canvas-rendered-editor-input.md) — companion mechanic for driving canvas-rendered text editors via dispatched events.
- [interaction-skills/canvas-camera-overlays.md](canvas-camera-overlays.md) — companion mechanic for canvas-rendered camera/map apps.
- Domain-skill examples that use this mechanic: see the `domain-skills/` directory for app-specific export trigger sequences.
